...
public class ReportBuilder {
    ...
    public static List<String> createStepsFromAnswers(final List<Question> questions) {
        ...
        if (maritalStatusQuestion.getAnswer()) {
            steps.add("---");
        } else {
        ...
        if (insuranceQuestion.getAnswer()) {
        ...
        if (shoppingMallQuestion.getAnswer()) {
        ...
        if (studentPassQuestion.getAnswer()) {
